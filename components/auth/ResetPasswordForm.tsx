            ...
            {success ? (
              ...
              <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <div className="space-y-2">
                  <label htmlFor="newPassword1" className="text-sm font-medium text-muted-foreground">
                    Neues Passwort
                  </label>
                  <Input
                    id="newPassword1"
                ...
                <div className="space-y-2">
                  <label htmlFor="newPassword2" className="text-sm font-medium text-muted-foreground">
                    Passwort bestätigen
                  </label>
                  <Input
                    id="newPassword2"
